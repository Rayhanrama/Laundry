...
<div class="mx-4 mt-4 p-3" style="border: 1px solid rgba(117, 151, 219, 0.262);">
    ...
    <div class="row">
       <div class="col-lg-12 margin-tb">
           ...
           <div>
               <a class="btn btn-primary mb-3 " href="{{ route('transaksi.index') }}"> Back</a>
           </div>
       </div>
    </div>
        ...
        <div class="row">
           ...
           <div class="col-xs-6 col-sm-6 col-md-6">
               <div class="form-group">
                   ...
                   <input class="form-control" name="telp" placeholder="telp" max="13">
               </div>
           </div>
           ...
           <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
                <strong>Berat:</strong>
                <input class="form-control" name="berat" placeholder="berat" max="13">
            </div>
        </div>
